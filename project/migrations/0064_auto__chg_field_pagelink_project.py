...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PageLink.project'
        db.alter_column(u'project_pagelink', 'project_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['project.Project'], null=True))

    def backwards(self, orm):

        # Changing field 'PageLink.project'
        db.alter_column(u'project_pagelink', 'project_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['project.Project']))
