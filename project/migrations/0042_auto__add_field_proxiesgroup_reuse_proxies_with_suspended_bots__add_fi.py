...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProxiesGroup.reuse_proxies_with_suspended_bots'
        db.add_column(u'project_proxiesgroup', 'reuse_proxies_with_suspended_bots',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'ProxiesGroup.reuse_proxies_with_dead_bots'
        db.add_column(u'project_proxiesgroup', 'reuse_proxies_with_dead_bots',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProxiesGroup.reuse_proxies_with_suspended_bots'
        db.delete_column(u'project_proxiesgroup', 'reuse_proxies_with_suspended_bots')

        # Deleting field 'ProxiesGroup.reuse_proxies_with_dead_bots'
        db.delete_column(u'project_proxiesgroup', 'reuse_proxies_with_dead_bots')
    ...
    models = {
        ...
        u'project.proxiesgroup': {
            ...
            'reuse_proxies_with_dead_bots': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
