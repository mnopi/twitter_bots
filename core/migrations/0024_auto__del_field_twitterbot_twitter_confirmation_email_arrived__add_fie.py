...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'TwitterBot.twitter_confirmation_email_arrived'
        db.delete_column(u'core_twitterbot', 'twitter_confirmation_email_arrived')
    ...
    def backwards(self, orm):
        # Adding field 'TwitterBot.twitter_confirmation_email_arrived'
        db.add_column(u'core_twitterbot', 'twitter_confirmation_email_arrived',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
