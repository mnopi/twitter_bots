...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Hashtag.is_active'
        db.add_column(u'project_hashtag', 'is_active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Hashtag.date_last_extraction'
        db.add_column(u'project_hashtag', 'date_last_extraction',
    ...
    def backwards(self, orm):
        # Deleting field 'Hashtag.is_active'
        db.delete_column(u'project_hashtag', 'is_active')

        # Deleting field 'Hashtag.date_last_extraction'
        db.delete_column(u'project_hashtag', 'date_last_extraction')
