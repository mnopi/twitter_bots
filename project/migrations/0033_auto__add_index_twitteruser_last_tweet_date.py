...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'TwitterUser', fields ['last_tweet_date']
        db.create_index(u'project_twitteruser', ['last_tweet_date'])


    def backwards(self, orm):
        # Removing index on 'TwitterUser', fields ['last_tweet_date']
        db.delete_index(u'project_twitteruser', ['last_tweet_date'])
