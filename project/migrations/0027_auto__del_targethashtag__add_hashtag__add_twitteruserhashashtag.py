...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'TargetHashtag'
        db.delete_table(u'project_targethashtag')

        # Adding model 'Hashtag'
        db.create_table(u'project_hashtag', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('q', self.gf('django.db.models.fields.CharField')(max_length=140)),
            ('geocode', self.gf('django.db.models.fields.CharField')(max_length=50, null=True)),
            ('lang', self.gf('django.db.models.fields.CharField')(max_length=2, null=True)),
            ('result_type', self.gf('django.db.models.fields.PositiveIntegerField')(default=2)),
            ('max_id', self.gf('django.db.models.fields.BigIntegerField')(null=True)),
            ('max_date_for_tweets', self.gf('django.db.models.fields.DateTimeField')(null=True)),
        ))
        db.send_create_signal(u'project', ['Hashtag'])

        # Adding model 'TwitterUserHasHashtag'
        db.create_table(u'project_twitteruserhashashtag', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('hashtag', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['project.Hashtag'])),
            ('twitter_user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['project.TwitterUser'])),
            ('date_saved', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'project', ['TwitterUserHasHashtag'])


    def backwards(self, orm):
        # Adding model 'TargetHashtag'
        db.create_table(u'project_targethashtag', (
            ('lang', self.gf('django.db.models.fields.CharField')(max_length=2, null=True)),
            ('q', self.gf('django.db.models.fields.CharField')(max_length=140)),
            ('max_date_for_tweets', self.gf('django.db.models.fields.DateTimeField')(null=True)),
            ('geocode', self.gf('django.db.models.fields.CharField')(max_length=50, null=True)),
        ...
        db.send_create_signal(u'project', ['TargetHashtag'])

        # Deleting model 'Hashtag'
        db.delete_table(u'project_hashtag')

        # Deleting model 'TwitterUserHasHashtag'
        db.delete_table(u'project_twitteruserhashashtag')
