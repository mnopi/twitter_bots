...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TwitterBot.proxy'
        db.alter_column(u'core_twitterbot', 'proxy_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.DO_NOTHING, to=orm['core.Proxy']))

    def backwards(self, orm):

        # Changing field 'TwitterBot.proxy'
        db.alter_column(u'core_twitterbot', 'proxy_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['core.Proxy']))
