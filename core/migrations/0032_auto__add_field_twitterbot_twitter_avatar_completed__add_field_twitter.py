...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TwitterBot.twitter_avatar_completed'
        db.add_column(u'core_twitterbot', 'twitter_avatar_completed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'TwitterBot.twitter_bio_completed'
        db.add_column(u'core_twitterbot', 'twitter_bio_completed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TwitterBot.twitter_avatar_completed'
        db.delete_column(u'core_twitterbot', 'twitter_avatar_completed')

        # Deleting field 'TwitterBot.twitter_bio_completed'
        db.delete_column(u'core_twitterbot', 'twitter_bio_completed')
    ...
    models = {
        ...
        u'core.twitterbot': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_kamikaze': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
