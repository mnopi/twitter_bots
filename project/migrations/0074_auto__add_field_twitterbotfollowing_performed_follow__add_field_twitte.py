...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TwitterBotFollowing.performed_follow'
        db.add_column(u'project_twitterbotfollowing', 'performed_follow',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'TwitterBotFollowing.followed_ok'
        db.add_column(u'project_twitterbotfollowing', 'followed_ok',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'TwitterBotFollowing.date_followed'
        db.add_column(u'project_twitterbotfollowing', 'date_followed',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TwitterBotFollowing.performed_follow'
        db.delete_column(u'project_twitterbotfollowing', 'performed_follow')

        # Deleting field 'TwitterBotFollowing.followed_ok'
        db.delete_column(u'project_twitterbotfollowing', 'followed_ok')

        # Deleting field 'TwitterBotFollowing.date_followed'
        db.delete_column(u'project_twitterbotfollowing', 'date_followed')
