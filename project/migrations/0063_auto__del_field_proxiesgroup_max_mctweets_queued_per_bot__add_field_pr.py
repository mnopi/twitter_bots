...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ProxiesGroup.max_mctweets_queued_per_bot'
        db.delete_column(u'project_proxiesgroup', 'max_mctweets_queued_per_bot')

        # Adding field 'ProxiesGroup.mctweet_to_same_bot_time_window'
        db.add_column(u'project_proxiesgroup', 'mctweet_to_same_bot_time_window',
                      self.gf('django.db.models.fields.CharField')(default='60-120', max_length=10),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'ProxiesGroup.max_mctweets_queued_per_bot'
        db.add_column(u'project_proxiesgroup', 'max_mctweets_queued_per_bot',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=3),
                      keep_default=False)

        # Deleting field 'ProxiesGroup.mctweet_to_same_bot_time_window'
        db.delete_column(u'project_proxiesgroup', 'mctweet_to_same_bot_time_window')
