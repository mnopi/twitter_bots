...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Tweet.date'
        db.alter_column(u'project_tweet', 'date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):

        # Changing field 'Tweet.date'
        db.alter_column(u'project_tweet', 'date', self.gf('django.db.models.fields.DateTimeField')())
