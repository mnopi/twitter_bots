...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Project.running'
        db.delete_column(u'project_project', 'running')

        # Adding field 'Project.is_running'
        db.add_column(u'project_project', 'is_running',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Project.running'
        db.add_column(u'project_project', 'running',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Deleting field 'Project.is_running'
        db.delete_column(u'project_project', 'is_running')
