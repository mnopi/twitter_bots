...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TwitterBot'
        db.create_table(u'core_twitterbot', (
        ...
        db.send_create_signal(u'core', ['TwitterBot'])


    def backwards(self, orm):
        # Deleting model 'TwitterBot'
        db.delete_table(u'core_twitterbot')
