...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TwitterBotFollowing'
        db.create_table(u'project_twitterbotfollowing', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('bot', self.gf('django.db.models.fields.related.ForeignKey')(related_name='tb_followings', to=orm['core.TwitterBot'])),
            ('twitteruser', self.gf('django.db.models.fields.related.ForeignKey')(related_name='tb_followings', to=orm['project.TwitterUser'])),
        ))
        db.send_create_signal(u'project', ['TwitterBotFollowing'])


    def backwards(self, orm):
        # Deleting model 'TwitterBotFollowing'
        db.delete_table(u'project_twitterbotfollowing')
