...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProxiesGroup.is_bot_usage_enabled'
        db.add_column(u'project_proxiesgroup', 'is_bot_usage_enabled',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProxiesGroup.is_bot_usage_enabled'
        db.delete_column(u'project_proxiesgroup', 'is_bot_usage_enabled')
