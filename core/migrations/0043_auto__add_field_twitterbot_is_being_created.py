...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TwitterBot.is_being_created'
        db.add_column(u'core_twitterbot', 'is_being_created',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TwitterBot.is_being_created'
        db.delete_column(u'core_twitterbot', 'is_being_created')
