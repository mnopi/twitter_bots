...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'TargetHashtag.country'
        db.delete_column(u'project_targethashtag', 'country')

        # Deleting field 'TargetHashtag.next_tweet_id'
        db.delete_column(u'project_targethashtag', 'next_tweet_id')

        # Deleting field 'TargetHashtag.text'
        db.delete_column(u'project_targethashtag', 'text')

        # Adding field 'TargetHashtag.q'
        db.add_column(u'project_targethashtag', 'q',
                      self.gf('django.db.models.fields.CharField')(default='casa', max_length=140),
                      keep_default=False)

        # Adding field 'TargetHashtag.geocode'
        db.add_column(u'project_targethashtag', 'geocode',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True),
                      keep_default=False)

        # Adding field 'TargetHashtag.lang'
        db.add_column(u'project_targethashtag', 'lang',
                      self.gf('django.db.models.fields.CharField')(max_length=2, null=True),
                      keep_default=False)

        # Adding field 'TargetHashtag.result_type'
        db.add_column(u'project_targethashtag', 'result_type',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=2),
                      keep_default=False)

        # Adding field 'TargetHashtag.max_id'
        db.add_column(u'project_targethashtag', 'max_id',
                      self.gf('django.db.models.fields.BigIntegerField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'TargetHashtag.country'
        db.add_column(u'project_targethashtag', 'country',
                      self.gf('django.db.models.fields.CharField')(max_length=2, null=True),
                      keep_default=False)

        # Adding field 'TargetHashtag.next_tweet_id'
        db.add_column(u'project_targethashtag', 'next_tweet_id',
                      self.gf('django.db.models.fields.BigIntegerField')(null=True),
                      keep_default=False)

        # Adding field 'TargetHashtag.text'
        db.add_column(u'project_targethashtag', 'text',
                      self.gf('django.db.models.fields.CharField')(default='casa', max_length=140),
                      keep_default=False)

        # Deleting field 'TargetHashtag.q'
        db.delete_column(u'project_targethashtag', 'q')

        # Deleting field 'TargetHashtag.geocode'
        db.delete_column(u'project_targethashtag', 'geocode')

        # Deleting field 'TargetHashtag.lang'
        db.delete_column(u'project_targethashtag', 'lang')

        # Deleting field 'TargetHashtag.result_type'
        db.delete_column(u'project_targethashtag', 'result_type')

        # Deleting field 'TargetHashtag.max_id'
        db.delete_column(u'project_targethashtag', 'max_id')
    ...
    models = {
        ...
        u'project.targethashtag': {
            'Meta': {'object_name': 'TargetHashtag'},
            ...
            'max_date_for_tweets': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
