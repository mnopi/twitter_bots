...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Proxy.proxies_group'
        db.alter_column(u'core_proxy', 'proxies_group_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['project.ProxiesGroup']))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Proxy.proxies_group'
        db.alter_column(u'core_proxy', 'proxies_group_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['project.ProxiesGroup']))
