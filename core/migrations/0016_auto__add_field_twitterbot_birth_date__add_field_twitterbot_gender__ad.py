...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TwitterBot.birth_date'
        db.add_column(u'core_twitterbot', 'birth_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'TwitterBot.gender'
        db.add_column(u'core_twitterbot', 'gender',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=1),
                      keep_default=False)

        # Adding field 'TwitterBot.has_fast_mode'
        db.add_column(u'core_twitterbot', 'has_fast_mode',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TwitterBot.birth_date'
        db.delete_column(u'core_twitterbot', 'birth_date')

        # Deleting field 'TwitterBot.gender'
        db.delete_column(u'core_twitterbot', 'gender')

        # Deleting field 'TwitterBot.has_fast_mode'
        db.delete_column(u'core_twitterbot', 'has_fast_mode')
    ...
    models = {
        ...
        u'core.twitterbot': {
            ...
            'proxy': ('django.db.models.fields.CharField', [], {'default': "'tor'", 'max_length': '21', 'blank': 'True'}),
