...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Extractor.rate_limited_date'
        db.delete_column(u'project_extractor', 'rate_limited_date')

        # Adding field 'Extractor.last_request_date'
        db.add_column(u'project_extractor', 'last_request_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Adding field 'Extractor.is_rate_limited'
        db.add_column(u'project_extractor', 'is_rate_limited',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Extractor.rate_limited_date'
        db.add_column(u'project_extractor', 'rate_limited_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Deleting field 'Extractor.last_request_date'
        db.delete_column(u'project_extractor', 'last_request_date')

        # Deleting field 'Extractor.is_rate_limited'
        db.delete_column(u'project_extractor', 'is_rate_limited')
