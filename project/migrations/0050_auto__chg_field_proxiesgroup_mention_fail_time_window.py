...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ProxiesGroup.mention_fail_time_window'
        db.alter_column(u'project_proxiesgroup', 'mention_fail_time_window', self.gf('django.db.models.fields.CharField')(max_length=10))

    def backwards(self, orm):

        # Changing field 'ProxiesGroup.mention_fail_time_window'
        db.alter_column(u'project_proxiesgroup', 'mention_fail_time_window', self.gf('django.db.models.fields.PositiveIntegerField')())
