...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'TwitterBot.using_selenium'
        db.delete_column(u'core_twitterbot', 'using_selenium')

        # Adding field 'TwitterBot.twitter_profile_completed'
        db.add_column(u'core_twitterbot', 'twitter_profile_completed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'TwitterBot.webdriver'
        db.add_column(u'core_twitterbot', 'webdriver',
                      self.gf('django.db.models.fields.CharField')(default='FI', max_length=2),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'TwitterBot.using_selenium'
        db.add_column(u'core_twitterbot', 'using_selenium',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Deleting field 'TwitterBot.twitter_profile_completed'
        db.delete_column(u'core_twitterbot', 'twitter_profile_completed')

        # Deleting field 'TwitterBot.webdriver'
        db.delete_column(u'core_twitterbot', 'webdriver')
    ...
    models = {
        ...
        u'core.twitterbot': {
            ...
            'twitter_confirmation_email_not_arrived': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'twitter_confirmed_email_ok': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'twitter_profile_completed': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
