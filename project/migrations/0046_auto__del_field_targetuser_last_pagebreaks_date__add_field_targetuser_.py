...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'TargetUser.last_pagebreaks_date'
        db.delete_column(u'project_targetuser', 'last_pagebreaks_date')

        # Adding field 'TargetUser.date_extraction_end'
        db.add_column(u'project_targetuser', 'date_extraction_end',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'TargetUser.last_pagebreaks_date'
        db.add_column(u'project_targetuser', 'last_pagebreaks_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'TargetUser.date_extraction_end'
        db.delete_column(u'project_targetuser', 'date_extraction_end')
    ...
    models = {
        ...
        u'project.proxiesgroup': {
            ...
            'min_days_between_registrations_per_proxy_under_same_subnet': ('django.db.models.fields.PositiveIntegerField', [], {'default': '5'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
