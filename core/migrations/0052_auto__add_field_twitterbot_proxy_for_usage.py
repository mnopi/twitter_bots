...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TwitterBot.proxy_for_usage'
        db.add_column(u'core_twitterbot', 'proxy_for_usage',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='twitter_bots_usingb', null=True, on_delete=models.DO_NOTHING, to=orm['core.Proxy']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TwitterBot.proxy_for_usage'
        db.delete_column(u'core_twitterbot', 'proxy_for_usage_id')
    ...
    models = {
        ...
        u'core.twitterbot': {
            ...
            'proxy_for_usage': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'twitter_bots_usingb'", 'null': 'True', 'on_delete': 'models.DO_NOTHING', 'to': u"orm['core.Proxy']"}),
