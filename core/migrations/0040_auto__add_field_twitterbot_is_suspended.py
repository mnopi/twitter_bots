...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TwitterBot.is_suspended'
        db.add_column(u'core_twitterbot', 'is_suspended',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TwitterBot.is_suspended'
        db.delete_column(u'core_twitterbot', 'is_suspended')
