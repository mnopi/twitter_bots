...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProxiesGroup.following_ratio'
        db.add_column(u'project_proxiesgroup', 'following_ratio',
                      self.gf('django.db.models.fields.CharField')(default='0.5-3', max_length=10),
                      keep_default=False)

        # Adding field 'ProxiesGroup.time_window_to_follow'
        db.add_column(u'project_proxiesgroup', 'time_window_to_follow',
                      self.gf('django.db.models.fields.CharField')(default='24-72', max_length=10),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProxiesGroup.following_ratio'
        db.delete_column(u'project_proxiesgroup', 'following_ratio')

        # Deleting field 'ProxiesGroup.time_window_to_follow'
        db.delete_column(u'project_proxiesgroup', 'time_window_to_follow')
    ...
    models = {
        ...
        u'project.proxiesgroup': {
            ...
            'time_window_to_follow': ('django.db.models.fields.CharField', [], {'default': "'24-72'", 'max_length': '10'}),
