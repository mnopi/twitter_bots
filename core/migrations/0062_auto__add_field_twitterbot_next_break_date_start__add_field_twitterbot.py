...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TwitterBot.next_break_date_start'
        db.add_column(u'core_twitterbot', 'next_break_date_start',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'TwitterBot.current_break_date_start'
        db.add_column(u'core_twitterbot', 'current_break_date_start',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'TwitterBot.current_break_duration'
        db.add_column(u'core_twitterbot', 'current_break_duration',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TwitterBot.next_break_date_start'
        db.delete_column(u'core_twitterbot', 'next_break_date_start')

        # Deleting field 'TwitterBot.current_break_date_start'
        db.delete_column(u'core_twitterbot', 'current_break_date_start')

        # Deleting field 'TwitterBot.current_break_duration'
        db.delete_column(u'core_twitterbot', 'current_break_duration')
    ...
    models = {
        ...
        u'core.twitterbot': {
            ...
            'current_break_duration': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True', 'blank': 'True'}),
