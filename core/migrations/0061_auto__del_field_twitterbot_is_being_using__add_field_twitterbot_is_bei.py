...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'TwitterBot.is_being_using'
        db.delete_column(u'core_twitterbot', 'is_being_using')

        # Adding field 'TwitterBot.is_being_used'
        db.add_column(u'core_twitterbot', 'is_being_used',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'TwitterBot.is_being_using'
        db.add_column(u'core_twitterbot', 'is_being_using',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'TwitterBot.is_being_used'
        db.delete_column(u'core_twitterbot', 'is_being_used')
