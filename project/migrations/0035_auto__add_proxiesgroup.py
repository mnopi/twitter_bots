...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ProxiesGroup'
        db.create_table(u'project_proxiesgroup', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('max_tw_bots_per_proxy_for_registration', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('max_tw_bots_per_proxy_for_usage', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('time_between_tweets', self.gf('django.db.models.fields.CharField')(max_length=10)),
            ('max_num_mentions_per_tweet', self.gf('django.db.models.fields.PositiveIntegerField')()),
        ))
        db.send_create_signal(u'project', ['ProxiesGroup'])

        # Adding M2M table for field projects on 'ProxiesGroup'
        m2m_table_name = db.shorten_name(u'project_proxiesgroup_projects')
        ...
        db.create_unique(m2m_table_name, ['proxiesgroup_id', 'project_id'])


    def backwards(self, orm):
        # Deleting model 'ProxiesGroup'
        db.delete_table(u'project_proxiesgroup')

        # Removing M2M table for field projects on 'ProxiesGroup'
        db.delete_table(db.shorten_name(u'project_proxiesgroup_projects'))
    ...
    models = {
        ...
        u'project.proxiesgroup': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'max_num_mentions_per_tweet': ('django.db.models.fields.PositiveIntegerField', [], {}),
            'max_tw_bots_per_proxy_for_registration': ('django.db.models.fields.PositiveIntegerField', [], {}),
            'max_tw_bots_per_proxy_for_usage': ('django.db.models.fields.PositiveIntegerField', [], {}),
            ...
            'time_between_tweets': ('django.db.models.fields.CharField', [], {'max_length': '10'})
        },
