...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'project_link', 'is_active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


        # Changing field 'Link.platform'
        db.alter_column(u'project_link', 'platform', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'TweetImg.img'
        db.alter_column(u'project_tweetimg', 'img', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))

    def backwards(self, orm):
        # Deleting field 'Link.is_active'
        db.delete_column(u'project_link', 'is_active')


        # Changing field 'Link.platform'
        db.alter_column(u'project_link', 'platform', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'TweetImg.img'
        db.alter_column(u'project_tweetimg', 'img', self.gf('django.db.models.fields.files.ImageField')(default='images/pipa1.png', max_length=100))
    ...
    models = {
        ...
        u'project.link': {
            ...
            'platform': ('django.db.models.fields.IntegerField', [], {'default': '0', 'null': 'True'}),
