...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProxiesGroup.mention_fail_time_window'
        db.add_column(u'project_proxiesgroup', 'mention_fail_time_window',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=3600),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProxiesGroup.mention_fail_time_window'
        db.delete_column(u'project_proxiesgroup', 'mention_fail_time_window')
    ...
    models = {
        ...
        u'project.proxiesgroup': {
            ...
            'mention_fail_time_window': ('django.db.models.fields.PositiveIntegerField', [], {'default': '3600'}),
