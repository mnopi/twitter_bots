...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FeedItem.date_saved'
        db.add_column(u'project_feeditem', 'date_saved',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2015, 1, 25, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FeedItem.date_saved'
        db.delete_column(u'project_feeditem', 'date_saved')
