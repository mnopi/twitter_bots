...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Follower', fields ['twitter_user']
        db.delete_unique(u'project_follower', ['twitter_user_id'])


        # Changing field 'Follower.twitter_user'
        db.alter_column(u'project_follower', 'twitter_user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['project.TwitterUser']))

    def backwards(self, orm):

        # Changing field 'Follower.twitter_user'
        db.alter_column(u'project_follower', 'twitter_user_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, to=orm['project.TwitterUser']))
        # Adding unique constraint on 'Follower', fields ['twitter_user']
        db.create_unique(u'project_follower', ['twitter_user_id'])
