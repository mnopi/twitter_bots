...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TargetUser.followers_count'
        db.add_column(u'project_targetuser', 'followers_count',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TargetUser.followers_count'
        db.delete_column(u'project_targetuser', 'followers_count')
