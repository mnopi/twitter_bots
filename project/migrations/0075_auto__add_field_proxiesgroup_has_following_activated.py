...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProxiesGroup.has_following_activated'
        db.add_column(u'project_proxiesgroup', 'has_following_activated',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProxiesGroup.has_following_activated'
        db.delete_column(u'project_proxiesgroup', 'has_following_activated')
