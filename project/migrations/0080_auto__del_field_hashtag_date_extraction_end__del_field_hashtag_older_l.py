...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Hashtag.date_extraction_end'
        db.delete_column(u'project_hashtag', 'date_extraction_end')
        ...
        # Adding field 'Hashtag.current_round_user_count'
        db.add_column(u'project_hashtag', 'current_round_user_count',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Hashtag.current_round_oldest_tweet_limit'
        db.add_column(u'project_hashtag', 'current_round_oldest_tweet_limit',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Hashtag.next_round_oldest_tweet_limit'
        db.add_column(u'project_hashtag', 'next_round_oldest_tweet_limit',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Hashtag.last_round_end_date'
        db.add_column(u'project_hashtag', 'last_round_end_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Hashtag.date_extraction_end'
        db.add_column(u'project_hashtag', 'date_extraction_end',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)
        ...
        # Deleting field 'Hashtag.current_round_user_count'
        db.delete_column(u'project_hashtag', 'current_round_user_count')

        # Deleting field 'Hashtag.current_round_oldest_tweet_limit'
        db.delete_column(u'project_hashtag', 'current_round_oldest_tweet_limit')

        # Deleting field 'Hashtag.next_round_oldest_tweet_limit'
        db.delete_column(u'project_hashtag', 'next_round_oldest_tweet_limit')

        # Deleting field 'Hashtag.last_round_end_date'
        db.delete_column(u'project_hashtag', 'last_round_end_date')
