...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'ProxyUsage'
        db.delete_table(u'core_proxyusage')


    def backwards(self, orm):
        # Adding model 'ProxyUsage'
        db.create_table(u'core_proxyusage', (
            ('username', self.gf('django.db.models.fields.CharField')(max_length=50, blank=True)),
            ('account', self.gf('django.db.models.fields.IntegerField')(max_length=1, blank=True)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('proxy', self.gf('django.db.models.fields.CharField')(max_length=21, blank=True)),
        ))
        db.send_create_signal(u'core', ['ProxyUsage'])
