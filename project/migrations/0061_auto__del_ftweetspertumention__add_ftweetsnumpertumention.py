...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'FTweetsNumPerTuMention'
        db.create_table(u'project_ftweetsnumpertumention', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('number', self.gf('django.db.models.fields.PositiveIntegerField')(default=0)),
            ('tu_mention', self.gf('django.db.models.fields.related.OneToOneField')(related_name='ftweets_num', unique=True, to=orm['project.Tweet'])),
        ))
        db.send_create_signal(u'project', ['FTweetsNumPerTuMention'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'FTweetsNumPerTuMention'
        db.delete_table(u'project_ftweetsnumpertumention')
