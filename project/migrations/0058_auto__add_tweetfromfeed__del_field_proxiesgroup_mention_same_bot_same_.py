...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TweetFromFeed'
        db.create_table(u'project_tweetfromfeed', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('tweet', self.gf('django.db.models.fields.related.OneToOneField')(related_name='tweet_from_feed', unique=True, to=orm['project.Tweet'])),
            ('twitteruser_mention', self.gf('django.db.models.fields.related.ForeignKey')(related_name='tweets_from_feed', to=orm['project.Tweet'])),
        ))
        db.send_create_signal(u'project', ['TweetFromFeed'])

        # Deleting field 'ProxiesGroup.mention_same_bot_same_tweet_time_window'
        db.delete_column(u'project_proxiesgroup', 'mention_same_bot_same_tweet_time_window')

        # Deleting field 'ProxiesGroup.mention_same_bot_distinct_tweet_time_window'
        db.delete_column(u'project_proxiesgroup', 'mention_same_bot_distinct_tweet_time_window')

        # Adding field 'ProxiesGroup.feedtweets_per_twitteruser_mention'
        db.add_column(u'project_proxiesgroup', 'feedtweets_per_twitteruser_mention',
                      self.gf('django.db.models.fields.CharField')(default='2-4', max_length=10),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'TweetFromFeed'
        db.delete_table(u'project_tweetfromfeed')

        # Adding field 'ProxiesGroup.mention_same_bot_same_tweet_time_window'
        db.add_column(u'project_proxiesgroup', 'mention_same_bot_same_tweet_time_window',
                      self.gf('django.db.models.fields.CharField')(default='80-200', max_length=10),
                      keep_default=False)

        # Adding field 'ProxiesGroup.mention_same_bot_distinct_tweet_time_window'
        db.add_column(u'project_proxiesgroup', 'mention_same_bot_distinct_tweet_time_window',
                      self.gf('django.db.models.fields.CharField')(default='30-90', max_length=10),
                      keep_default=False)

        # Deleting field 'ProxiesGroup.feedtweets_per_twitteruser_mention'
        db.delete_column(u'project_proxiesgroup', 'feedtweets_per_twitteruser_mention')
