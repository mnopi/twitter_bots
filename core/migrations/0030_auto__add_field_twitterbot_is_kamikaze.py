...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TwitterBot.is_kamikaze'
        db.add_column(u'core_twitterbot', 'is_kamikaze',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TwitterBot.is_kamikaze'
        db.delete_column(u'core_twitterbot', 'is_kamikaze')
