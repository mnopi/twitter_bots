...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Tweet.date'
        db.delete_column(u'project_tweet', 'date')

        # Adding field 'Tweet.date_created'
        db.add_column(u'project_tweet', 'date_created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2014, 9, 24, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Tweet.date_sent'
        db.add_column(u'project_tweet', 'date_sent',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Adding field 'Tweet.bot_used'
        db.add_column(u'project_tweet', 'bot_used',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='tweets', to=orm['core.TwitterBot']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Tweet.date'
        db.add_column(u'project_tweet', 'date',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2014, 9, 24, 0, 0), blank=True),
                      keep_default=False)

        # Deleting field 'Tweet.date_created'
        db.delete_column(u'project_tweet', 'date_created')

        # Deleting field 'Tweet.date_sent'
        db.delete_column(u'project_tweet', 'date_sent')

        # Deleting field 'Tweet.bot_used'
        db.delete_column(u'project_tweet', 'bot_used_id')
    ...
    models = {
        ...
        u'project.tweet': {
            ...
            'bot_used': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'tweets'", 'to': u"orm['core.TwitterBot']"}),
