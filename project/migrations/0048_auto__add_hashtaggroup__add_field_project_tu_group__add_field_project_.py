...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'project_project', 'tu_group',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='tu_group', null=True, to=orm['project.TUGroup']),
                      keep_default=False)

        # Adding field 'Project.hashtag_group'
        db.add_column(u'project_project', 'hashtag_group',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='hashtag_group', null=True, to=orm['project.HashtagGroup']),
                      keep_default=False)
    ...
    models = {
        ...
        u'project.project': {
            ...
            'hashtag_group': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'hashtag_group'", 'null': 'True', 'to': u"orm['project.HashtagGroup']"}),
            ...
            'tu_group': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'tu_group'", 'null': 'True', 'to': u"orm['project.TUGroup']"})
        },
