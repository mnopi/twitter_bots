...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TargetUser.is_active'
        db.add_column(u'project_targetuser', 'is_active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TargetUser.is_active'
        db.delete_column(u'project_targetuser', 'is_active')
