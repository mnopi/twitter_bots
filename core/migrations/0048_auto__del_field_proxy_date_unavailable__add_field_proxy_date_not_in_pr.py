...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Proxy.date_not_in_proxies_txts'
        db.add_column(u'core_proxy', 'date_not_in_proxies_txts',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Proxy.date_not_in_proxies_txts'
        db.delete_column(u'core_proxy', 'date_not_in_proxies_txts')
