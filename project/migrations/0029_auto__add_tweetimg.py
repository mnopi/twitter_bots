...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TweetImg'
        db.create_table(u'project_tweetimg', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('img', self.gf('django.db.models.fields.files.ImageField')(max_length=100)),
            ('is_using', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(related_name='tweet_imgs', to=orm['project.Project'])),
        ))
        db.send_create_signal(u'project', ['TweetImg'])


    def backwards(self, orm):
        # Deleting model 'TweetImg'
        db.delete_table(u'project_tweetimg')
