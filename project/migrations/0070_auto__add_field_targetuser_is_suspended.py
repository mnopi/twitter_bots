...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TargetUser.is_suspended'
        db.add_column(u'project_targetuser', 'is_suspended',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TargetUser.is_suspended'
        db.delete_column(u'project_targetuser', 'is_suspended')
