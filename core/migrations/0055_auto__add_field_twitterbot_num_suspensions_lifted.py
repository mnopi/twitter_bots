...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TwitterBot.num_suspensions_lifted'
        db.add_column(u'core_twitterbot', 'num_suspensions_lifted',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TwitterBot.num_suspensions_lifted'
        db.delete_column(u'core_twitterbot', 'num_suspensions_lifted')
