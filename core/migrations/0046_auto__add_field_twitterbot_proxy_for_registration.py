...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TwitterBot.proxy_for_registration'
        db.add_column(u'core_twitterbot', 'proxy_for_registration',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='twitter_bots_registered', null=True, on_delete=models.DO_NOTHING, to=orm['core.Proxy']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TwitterBot.proxy_for_registration'
        db.delete_column(u'core_twitterbot', 'proxy_for_registration_id')
