...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PageLinkHashtag'
        db.create_table(u'project_pagelinkhashtag', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal(u'project', ['PageLinkHashtag'])

        # Adding model 'PageLink'
        db.create_table(u'project_pagelink', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('page_title', self.gf('django.db.models.fields.CharField')(max_length=150, null=True, blank=True)),
            ('page_link', self.gf('django.db.models.fields.URLField')(max_length=200)),
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['project.Project'])),
            ('is_active', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('hashtag', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='page_links', null=True, to=orm['project.PageLinkHashtag'])),
        ))
        db.send_create_signal(u'project', ['PageLink'])

        # Adding field 'Tweet.page_announced'
        db.add_column(u'project_tweet', 'page_announced',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='tweets', null=True, to=orm['project.PageLink']),
                      keep_default=False)

        # Adding field 'Tweet.tweet_img'
        db.add_column(u'project_tweet', 'tweet_img',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['project.TweetImg'], null=True, blank=True),
                      keep_default=False)


        # Changing field 'Tweet.tweet_msg'
        db.alter_column(u'project_tweet', 'tweet_msg_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['project.TweetMsg'], null=True))
        # Adding field 'ProxiesGroup.has_tweet_msg'
        db.add_column(u'project_proxiesgroup', 'has_tweet_msg',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'ProxiesGroup.has_link'
        db.add_column(u'project_proxiesgroup', 'has_link',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'ProxiesGroup.has_tweet_img'
        db.add_column(u'project_proxiesgroup', 'has_tweet_img',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'ProxiesGroup.has_page_announced'
        db.add_column(u'project_proxiesgroup', 'has_page_announced',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'ProxiesGroup.has_mentions'
        db.add_column(u'project_proxiesgroup', 'has_mentions',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'PageLinkHashtag'
        db.delete_table(u'project_pagelinkhashtag')

        # Deleting model 'PageLink'
        db.delete_table(u'project_pagelink')

        # Deleting field 'Tweet.page_announced'
        db.delete_column(u'project_tweet', 'page_announced_id')

        # Deleting field 'Tweet.tweet_img'
        db.delete_column(u'project_tweet', 'tweet_img_id')


        # Changing field 'Tweet.tweet_msg'
        db.alter_column(u'project_tweet', 'tweet_msg_id', self.gf('django.db.models.fields.related.ForeignKey')(default=False, to=orm['project.TweetMsg']))
        # Deleting field 'ProxiesGroup.has_tweet_msg'
        db.delete_column(u'project_proxiesgroup', 'has_tweet_msg')

        # Deleting field 'ProxiesGroup.has_link'
        db.delete_column(u'project_proxiesgroup', 'has_link')

        # Deleting field 'ProxiesGroup.has_tweet_img'
        db.delete_column(u'project_proxiesgroup', 'has_tweet_img')

        # Deleting field 'ProxiesGroup.has_page_announced'
        db.delete_column(u'project_proxiesgroup', 'has_page_announced')

        # Deleting field 'ProxiesGroup.has_mentions'
        db.delete_column(u'project_proxiesgroup', 'has_mentions')
