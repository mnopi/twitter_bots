...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProxiesGroup.max_tweets_at_once'
        db.add_column(u'project_proxiesgroup', 'max_tweets_at_once',
                      self.gf('django.db.models.fields.CharField')(default='15-20', max_length=10),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProxiesGroup.max_tweets_at_once'
        db.delete_column(u'project_proxiesgroup', 'max_tweets_at_once')
