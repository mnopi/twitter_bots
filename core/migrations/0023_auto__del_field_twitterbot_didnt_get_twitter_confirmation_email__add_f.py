...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'TwitterBot.didnt_get_twitter_confirmation_email'
        db.delete_column(u'core_twitterbot', 'didnt_get_twitter_confirmation_email')
    ...
    def backwards(self, orm):
        # Adding field 'TwitterBot.didnt_get_twitter_confirmation_email'
        db.add_column(u'core_twitterbot', 'didnt_get_twitter_confirmation_email',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
    ...
    models = {
        ...
        u'core.twitterbot': {
            ...
            'twitter_confirmation_email_arrived': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
