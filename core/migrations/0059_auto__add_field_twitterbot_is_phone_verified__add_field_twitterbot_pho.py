...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TwitterBot.is_phone_verified'
        db.add_column(u'core_twitterbot', 'is_phone_verified',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'TwitterBot.phone_number'
        db.add_column(u'core_twitterbot', 'phone_number',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TwitterBot.is_phone_verified'
        db.delete_column(u'core_twitterbot', 'is_phone_verified')

        # Deleting field 'TwitterBot.phone_number'
        db.delete_column(u'core_twitterbot', 'phone_number')
