...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Tweet.link'
        db.add_column(u'project_tweet', 'link',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='tweet', null=True, to=orm['project.Link']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Tweet.link'
        db.delete_column(u'project_tweet', 'link_id')
    ...
    models = {
        ...
        u'project.tweet': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'link': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'tweet'", 'null': 'True', 'to': u"orm['project.Link']"}),
