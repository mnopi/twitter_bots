...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'TwitterBot.twitter_confirmation_email_not_arrived'
        db.delete_column(u'core_twitterbot', 'twitter_confirmation_email_not_arrived')

        # Adding field 'TwitterBot.random_offsets'
        db.add_column(u'core_twitterbot', 'random_offsets',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'TwitterBot.random_mouse_paths'
        db.add_column(u'core_twitterbot', 'random_mouse_paths',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'TwitterBot.twitter_confirmation_email_not_arrived'
        db.add_column(u'core_twitterbot', 'twitter_confirmation_email_not_arrived',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'TwitterBot.random_offsets'
        db.delete_column(u'core_twitterbot', 'random_offsets')

        # Deleting field 'TwitterBot.random_mouse_paths'
        db.delete_column(u'core_twitterbot', 'random_mouse_paths')
