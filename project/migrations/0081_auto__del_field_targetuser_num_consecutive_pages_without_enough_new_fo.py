...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'TargetUser.num_consecutive_pages_without_enough_new_followers'
        db.delete_column(u'project_targetuser', 'num_consecutive_pages_without_enough_new_followers')

        # Adding field 'TargetUser.num_consecutive_pages_without_enough_new_twitterusers'
        db.add_column(u'project_targetuser', 'num_consecutive_pages_without_enough_new_twitterusers',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, null=True),
                      keep_default=False)

        # Adding field 'Hashtag.has_to_wait_timewindow_because_of_not_enough_new_twitterusers'
        db.add_column(u'project_hashtag', 'has_to_wait_timewindow_because_of_not_enough_new_twitterusers',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Hashtag.num_consecutive_pages_without_enough_new_twitterusers'
        db.add_column(u'project_hashtag', 'num_consecutive_pages_without_enough_new_twitterusers',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'TargetUser.num_consecutive_pages_without_enough_new_followers'
        db.add_column(u'project_targetuser', 'num_consecutive_pages_without_enough_new_followers',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, null=True),
                      keep_default=False)

        # Deleting field 'TargetUser.num_consecutive_pages_without_enough_new_twitterusers'
        db.delete_column(u'project_targetuser', 'num_consecutive_pages_without_enough_new_twitterusers')

        # Deleting field 'Hashtag.has_to_wait_timewindow_because_of_not_enough_new_twitterusers'
        db.delete_column(u'project_hashtag', 'has_to_wait_timewindow_because_of_not_enough_new_twitterusers')

        # Deleting field 'Hashtag.num_consecutive_pages_without_enough_new_twitterusers'
        db.delete_column(u'project_hashtag', 'num_consecutive_pages_without_enough_new_twitterusers')
    ...
    models = {
        ...
        u'project.hashtag': {
            ...
            'max_consecutive_pages_retrieved': ('django.db.models.fields.PositiveIntegerField', [], {'default': '1'}),
