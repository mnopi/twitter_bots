...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Extractor.is_suspended'
        db.add_column(u'project_extractor', 'is_suspended',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Extractor.date_suspended'
        db.add_column(u'project_extractor', 'date_suspended',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Extractor.is_suspended'
        db.delete_column(u'project_extractor', 'is_suspended')

        # Deleting field 'Extractor.date_suspended'
        db.delete_column(u'project_extractor', 'date_suspended')
