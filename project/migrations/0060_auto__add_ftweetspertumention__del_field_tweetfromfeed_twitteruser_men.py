...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'FTweetsPerTuMention'
        db.create_table(u'project_ftweetspertumention', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('number', self.gf('django.db.models.fields.PositiveIntegerField')(default=0)),
            ('tu_mention', self.gf('django.db.models.fields.related.OneToOneField')(related_name='ftweets_to_send', unique=True, to=orm['project.Tweet'])),
        ))
        db.send_create_signal(u'project', ['FTweetsPerTuMention'])

        # Deleting field 'TweetFromFeed.twitteruser_mention'
        db.delete_column(u'project_tweetfromfeed', 'twitteruser_mention_id')

        # Adding field 'TweetFromFeed.tu_mention'
        db.add_column(u'project_tweetfromfeed', 'tu_mention',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='tweets_from_feed', to=orm['project.Tweet']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'FTweetsPerTuMention'
        db.delete_table(u'project_ftweetspertumention')

        # Adding field 'TweetFromFeed.twitteruser_mention'
        db.add_column(u'project_tweetfromfeed', 'twitteruser_mention',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='tweets_from_feed', to=orm['project.Tweet']),
                      keep_default=False)

        # Deleting field 'TweetFromFeed.tu_mention'
        db.delete_column(u'project_tweetfromfeed', 'tu_mention_id')
    ...
    models = {
        ...
        u'project.ftweetspertumention': {
            'Meta': {'object_name': 'FTweetsPerTuMention'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'number': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
            'tu_mention': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'ftweets_to_send'", 'unique': 'True', 'to': u"orm['project.Tweet']"})
        },
        u'project.hashtag': {
