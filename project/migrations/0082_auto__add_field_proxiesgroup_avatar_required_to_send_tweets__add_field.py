...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProxiesGroup.avatar_required_to_send_tweets'
        db.add_column(u'project_proxiesgroup', 'avatar_required_to_send_tweets',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'ProxiesGroup.bio_required_to_send_tweets'
        db.add_column(u'project_proxiesgroup', 'bio_required_to_send_tweets',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProxiesGroup.avatar_required_to_send_tweets'
        db.delete_column(u'project_proxiesgroup', 'avatar_required_to_send_tweets')

        # Deleting field 'ProxiesGroup.bio_required_to_send_tweets'
        db.delete_column(u'project_proxiesgroup', 'bio_required_to_send_tweets')
