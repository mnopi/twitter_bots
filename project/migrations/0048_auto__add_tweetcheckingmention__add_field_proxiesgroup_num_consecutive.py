...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TweetCheckingMention'
        db.create_table(u'project_tweetcheckingmention', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('tweet', self.gf('django.db.models.fields.related.OneToOneField')(related_name='tweet_checking_mention', unique=True, to=orm['project.Tweet'])),
            ('mentioning_works', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'project', ['TweetCheckingMention'])

        # Adding M2M table for field mentioned_bots on 'Tweet'
        m2m_table_name = db.shorten_name(u'project_tweet_mentioned_bots')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('tweet', models.ForeignKey(orm[u'project.tweet'], null=False)),
            ('twitterbot', models.ForeignKey(orm[u'core.twitterbot'], null=False))
        ))
        db.create_unique(m2m_table_name, ['tweet_id', 'twitterbot_id'])

        # Adding field 'ProxiesGroup.num_consecutive_mentions_for_check_mentioning_works'
        db.add_column(u'project_proxiesgroup', 'num_consecutive_mentions_for_check_mentioning_works',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=5),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'TweetCheckingMention'
        db.delete_table(u'project_tweetcheckingmention')

        # Removing M2M table for field mentioned_bots on 'Tweet'
        db.delete_table(db.shorten_name(u'project_tweet_mentioned_bots'))

        # Deleting field 'ProxiesGroup.num_consecutive_mentions_for_check_mentioning_works'
        db.delete_column(u'project_proxiesgroup', 'num_consecutive_mentions_for_check_mentioning_works')
