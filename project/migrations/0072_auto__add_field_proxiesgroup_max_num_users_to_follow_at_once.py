...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProxiesGroup.max_num_users_to_follow_at_once'
        db.add_column(u'project_proxiesgroup', 'max_num_users_to_follow_at_once',
                      self.gf('django.db.models.fields.CharField')(default='1-8', max_length=10),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProxiesGroup.max_num_users_to_follow_at_once'
        db.delete_column(u'project_proxiesgroup', 'max_num_users_to_follow_at_once')
