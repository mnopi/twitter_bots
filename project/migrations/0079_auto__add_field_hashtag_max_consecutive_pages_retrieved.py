...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Hashtag.max_consecutive_pages_retrieved'
        db.add_column(u'project_hashtag', 'max_consecutive_pages_retrieved',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Hashtag.max_consecutive_pages_retrieved'
        db.delete_column(u'project_hashtag', 'max_consecutive_pages_retrieved')
