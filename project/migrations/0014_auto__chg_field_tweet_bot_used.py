...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Tweet.bot_used'
        db.alter_column(u'project_tweet', 'bot_used_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['core.TwitterBot']))

    def backwards(self, orm):

        # Changing field 'Tweet.bot_used'
        db.alter_column(u'project_tweet', 'bot_used_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['core.TwitterBot']))
