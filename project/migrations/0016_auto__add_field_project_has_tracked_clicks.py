...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Project.has_tracked_clicks'
        db.add_column(u'project_project', 'has_tracked_clicks',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Project.has_tracked_clicks'
        db.delete_column(u'project_project', 'has_tracked_clicks')
    ...
    models = {
        ...
        u'project.project': {
            ...
            'running': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
