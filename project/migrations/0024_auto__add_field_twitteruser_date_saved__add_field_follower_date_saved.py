...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TwitterUser.date_saved'
        db.add_column(u'project_twitteruser', 'date_saved',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2014, 10, 3, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Follower.date_saved'
        db.add_column(u'project_follower', 'date_saved',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2014, 10, 3, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TwitterUser.date_saved'
        db.delete_column(u'project_twitteruser', 'date_saved')

        # Deleting field 'Follower.date_saved'
        db.delete_column(u'project_follower', 'date_saved')
