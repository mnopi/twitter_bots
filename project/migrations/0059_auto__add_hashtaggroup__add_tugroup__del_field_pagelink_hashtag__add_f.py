...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'HashtagGroup'
        db.create_table(u'project_hashtaggroup', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=140)),
        ))
        db.send_create_signal(u'project', ['HashtagGroup'])

        # Adding M2M table for field hashtags on 'HashtagGroup'
        m2m_table_name = db.shorten_name(u'project_hashtaggroup_hashtags')
        ...
        db.create_unique(m2m_table_name, ['hashtaggroup_id', 'hashtag_id'])

        # Adding M2M table for field projects on 'HashtagGroup'
        m2m_table_name = db.shorten_name(u'project_hashtaggroup_projects')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('hashtaggroup', models.ForeignKey(orm[u'project.hashtaggroup'], null=False)),
            ('project', models.ForeignKey(orm[u'project.project'], null=False))
        ))
        db.create_unique(m2m_table_name, ['hashtaggroup_id', 'project_id'])

        # Adding model 'TUGroup'
        db.create_table(u'project_tugroup', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=140)),
        ))
        db.send_create_signal(u'project', ['TUGroup'])

        # Adding M2M table for field target_users on 'TUGroup'
        m2m_table_name = db.shorten_name(u'project_tugroup_target_users')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
        ...
        db.create_unique(m2m_table_name, ['tugroup_id', 'targetuser_id'])

        # Adding M2M table for field projects on 'TUGroup'
        m2m_table_name = db.shorten_name(u'project_tugroup_projects')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('tugroup', models.ForeignKey(orm[u'project.tugroup'], null=False)),
            ('project', models.ForeignKey(orm[u'project.project'], null=False))
        ))
        db.create_unique(m2m_table_name, ['tugroup_id', 'project_id'])
        ...
        # Deleting field 'PageLink.hashtag'
        db.delete_column(u'project_pagelink', 'hashtag_id')

        # Adding field 'PageLink.image'
        db.add_column(u'project_pagelink', 'image',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='page_img', null=True, to=orm['project.TweetImg']),
                      keep_default=False)

        # Adding field 'PageLink.language'
        db.add_column(u'project_pagelink', 'language',
                      self.gf('django.db.models.fields.CharField')(max_length=2, null=True, blank=True),
                      keep_default=False)

        # Adding M2M table for field hashtags on 'PageLink'
        m2m_table_name = db.shorten_name(u'project_pagelink_hashtags')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('pagelink', models.ForeignKey(orm[u'project.pagelink'], null=False)),
            ('pagelinkhashtag', models.ForeignKey(orm[u'project.pagelinkhashtag'], null=False))
        ))
        db.create_unique(m2m_table_name, ['pagelink_id', 'pagelinkhashtag_id'])


    def backwards(self, orm):
        # Deleting model 'HashtagGroup'
        db.delete_table(u'project_hashtaggroup')

        # Removing M2M table for field hashtags on 'HashtagGroup'
        db.delete_table(db.shorten_name(u'project_hashtaggroup_hashtags'))

        # Removing M2M table for field projects on 'HashtagGroup'
        db.delete_table(db.shorten_name(u'project_hashtaggroup_projects'))

        # Deleting model 'TUGroup'
        db.delete_table(u'project_tugroup')

        # Removing M2M table for field target_users on 'TUGroup'
        db.delete_table(db.shorten_name(u'project_tugroup_target_users'))

        # Removing M2M table for field projects on 'TUGroup'
        db.delete_table(db.shorten_name(u'project_tugroup_projects'))
        ...
        # Adding field 'PageLink.hashtag'
        db.add_column(u'project_pagelink', 'hashtag',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='page_links', null=True, to=orm['project.PageLinkHashtag'], blank=True),
                      keep_default=False)

        # Deleting field 'PageLink.image'
        db.delete_column(u'project_pagelink', 'image_id')

        # Deleting field 'PageLink.language'
        db.delete_column(u'project_pagelink', 'language')

        # Removing M2M table for field hashtags on 'PageLink'
        db.delete_table(db.shorten_name(u'project_pagelink_hashtags'))
    ...
    models = {
        ...
        u'project.hashtaggroup': {
            ...
            'projects': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'projects_hashtag_group'", 'symmetrical': 'False', 'to': u"orm['project.Project']"})
        },
        u'project.link': {
        ...
        u'project.proxiesgroup': {
            ...
            'destination_bot_checking_time_window': ('django.db.models.fields.CharField', [], {'default': "'2-5'", 'max_length': '10'}),
            'feedtweets_per_twitteruser_mention': ('django.db.models.fields.CharField', [], {'default': "'2-4'", 'max_length': '10'}),
        ...
        u'project.tugroup': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '140'}),
            'projects': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'projects_tu_group'", 'symmetrical': 'False', 'to': u"orm['project.Project']"}),
        ...
        u'project.tweet': {
            ...
            'feed_item': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'tweets'", 'null': 'True', 'to': u"orm['project.FeedItem']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'tweet_img': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'tweets'", 'null': 'True', 'to': u"orm['project.TweetImg']"}),
            'tweet_msg': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['project.TweetMsg']", 'null': 'True', 'blank': 'True'})
        },
        ...
        u'project.tweetfromfeed': {
            ...
            'twitteruser_mention': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'tweets_from_feed'", 'to': u"orm['project.Tweet']"})
        },
        u'project.tweetimg': {
