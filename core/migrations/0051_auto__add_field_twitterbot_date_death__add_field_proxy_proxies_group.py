...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TwitterBot.date_death'
        db.add_column(u'core_twitterbot', 'date_death',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Proxy.proxies_group'
        db.add_column(u'core_proxy', 'proxies_group',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='proxies', null=True, to=orm['project.ProxiesGroup']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TwitterBot.date_death'
        db.delete_column(u'core_twitterbot', 'date_death')

        # Deleting field 'Proxy.proxies_group'
        db.delete_column(u'core_proxy', 'proxies_group_id')
