...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TwitterBot.is_following'
        db.add_column(u'core_twitterbot', 'is_following',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'TwitterBot.date_last_following'
        db.add_column(u'core_twitterbot', 'date_last_following',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TwitterBot.is_following'
        db.delete_column(u'core_twitterbot', 'is_following')

        # Deleting field 'TwitterBot.date_last_following'
        db.delete_column(u'core_twitterbot', 'date_last_following')
