...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'core_proxiesgroup', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
        db.send_create_signal(u'core', ['ProxiesGroup'])

        # Adding field 'Proxy.proxies_group'
        db.add_column(u'core_proxy', 'proxies_group',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='proxies', null=True, to=orm['core.ProxiesGroup']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'ProxiesGroup'
        db.delete_table(u'core_proxiesgroup')
    ...
    models = {
        ...
        u'core.proxy': {
            ...
            'proxies_group': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'proxies'", 'null': 'True', 'to': u"orm['core.ProxiesGroup']"}),
