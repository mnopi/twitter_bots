...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProxiesGroup.min_days_between_registrations_per_proxy'
        db.add_column(u'project_proxiesgroup', 'min_days_between_registrations_per_proxy',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=5),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProxiesGroup.min_days_between_registrations_per_proxy'
        db.delete_column(u'project_proxiesgroup', 'min_days_between_registrations_per_proxy')
