...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Extractor.proxy_provider'
        db.delete_column(u'project_extractor', 'proxy_provider')

        # Deleting field 'Extractor.proxy'
        db.delete_column(u'project_extractor', 'proxy')

        # Adding field 'Extractor.twitter_bot'
        db.add_column(u'project_extractor', 'twitter_bot',
                      self.gf('django.db.models.fields.related.OneToOneField')(default=652, to=orm['core.TwitterBot'], unique=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Extractor.proxy_provider'
        db.add_column(u'project_extractor', 'proxy_provider',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)

        # Adding field 'Extractor.proxy'
        db.add_column(u'project_extractor', 'proxy',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=21, blank=True),
                      keep_default=False)

        # Deleting field 'Extractor.twitter_bot'
        db.delete_column(u'project_extractor', 'twitter_bot_id')
    ...
    models = {
        ...
        u'project.extractor': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'twitter_bot': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['core.TwitterBot']", 'unique': 'True'})
        },
        u'project.follower': {
