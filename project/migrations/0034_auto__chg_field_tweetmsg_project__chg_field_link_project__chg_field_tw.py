...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TweetMsg.project'
        db.alter_column(u'project_tweetmsg', 'project_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['project.Project']))

        # Changing field 'Link.project'
        db.alter_column(u'project_link', 'project_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['project.Project']))

        # Changing field 'Tweet.project'
        db.alter_column(u'project_tweet', 'project_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['project.Project']))

    def backwards(self, orm):

        # Changing field 'TweetMsg.project'
        db.alter_column(u'project_tweetmsg', 'project_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['project.Project']))

        # Changing field 'Link.project'
        db.alter_column(u'project_link', 'project_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['project.Project']))

        # Changing field 'Tweet.project'
        db.alter_column(u'project_tweet', 'project_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['project.Project']))
    ...
    models = {
        ...
        u'project.tweetmsg': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'project': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'tweet_msgs'", 'null': 'True', 'blank': 'True', 'to': u"orm['project.Project']"}),
