...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Proxy.date_added'
        db.add_column(u'core_proxy', 'date_added',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2014, 10, 13, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Proxy.date_added'
        db.delete_column(u'core_proxy', 'date_added')
