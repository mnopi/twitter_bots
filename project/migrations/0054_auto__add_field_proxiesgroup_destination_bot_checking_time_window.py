...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProxiesGroup.destination_bot_checking_time_window'
        db.add_column(u'project_proxiesgroup', 'destination_bot_checking_time_window',
                      self.gf('django.db.models.fields.CharField')(default='2-5', max_length=10),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProxiesGroup.destination_bot_checking_time_window'
        db.delete_column(u'project_proxiesgroup', 'destination_bot_checking_time_window')
