...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'FeedsGroup'
        db.create_table(u'project_feedsgroup', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal(u'project', ['FeedsGroup'])

        # Adding M2M table for field feeds on 'FeedsGroup'
        m2m_table_name = db.shorten_name(u'project_feedsgroup_feeds')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('feedsgroup', models.ForeignKey(orm[u'project.feedsgroup'], null=False)),
            ('feed', models.ForeignKey(orm[u'project.feed'], null=False))
        ))
        db.create_unique(m2m_table_name, ['feedsgroup_id', 'feed_id'])

        # Adding M2M table for field proxies_groups on 'FeedsGroup'
        m2m_table_name = db.shorten_name(u'project_feedsgroup_proxies_groups')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('feedsgroup', models.ForeignKey(orm[u'project.feedsgroup'], null=False)),
            ('proxiesgroup', models.ForeignKey(orm[u'project.proxiesgroup'], null=False))
        ))
        db.create_unique(m2m_table_name, ['feedsgroup_id', 'proxiesgroup_id'])

        # Adding model 'FeedItem'
        db.create_table(u'project_feeditem', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('feed', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['project.Feed'])),
            ('text', self.gf('django.db.models.fields.CharField')(max_length=101)),
        ))
        db.send_create_signal(u'project', ['FeedItem'])

        # Adding model 'Feed'
        db.create_table(u'project_feed', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('url', self.gf('django.db.models.fields.URLField')(max_length=200)),
        ))
        db.send_create_signal(u'project', ['Feed'])

        # Adding field 'Tweet.feed_item'
        db.add_column(u'project_tweet', 'feed_item',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['project.FeedItem'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'FeedsGroup'
        db.delete_table(u'project_feedsgroup')

        # Removing M2M table for field feeds on 'FeedsGroup'
        db.delete_table(db.shorten_name(u'project_feedsgroup_feeds'))

        # Removing M2M table for field proxies_groups on 'FeedsGroup'
        db.delete_table(db.shorten_name(u'project_feedsgroup_proxies_groups'))

        # Deleting model 'FeedItem'
        db.delete_table(u'project_feeditem')

        # Deleting model 'Feed'
        db.delete_table(u'project_feed')

        # Deleting field 'Tweet.feed_item'
        db.delete_column(u'project_tweet', 'feed_item_id')
    ...
    models = {
        ...
        u'project.tweet': {
            ...
            'feed_item': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['project.FeedItem']", 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
