...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TweetCheckingMention.destination_bot_is_checking_mention'
        db.add_column(u'project_tweetcheckingmention', 'destination_bot_is_checking_mention',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TweetCheckingMention.destination_bot_is_checking_mention'
        db.delete_column(u'project_tweetcheckingmention', 'destination_bot_is_checking_mention')
