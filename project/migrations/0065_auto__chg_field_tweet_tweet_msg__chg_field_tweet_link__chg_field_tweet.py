...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'project_tweet', 'tweet_msg_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['project.TweetMsg'], null=True, on_delete=models.PROTECT))

        # Changing field 'Tweet.link'
        db.alter_column(u'project_tweet', 'link_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.PROTECT, to=orm['project.Link']))

        # Changing field 'Tweet.page_announced'
        db.alter_column(u'project_tweet', 'page_announced_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.PROTECT, to=orm['project.PageLink']))

        # Changing field 'Tweet.tweet_img'
        db.alter_column(u'project_tweet', 'tweet_img_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.PROTECT, to=orm['project.TweetImg']))

        # Changing field 'Tweet.feed_item'
        db.alter_column(u'project_tweet', 'feed_item_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.PROTECT, to=orm['project.FeedItem']))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Tweet.link'
        db.alter_column(u'project_tweet', 'link_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['project.Link']))

        # Changing field 'Tweet.page_announced'
        db.alter_column(u'project_tweet', 'page_announced_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['project.PageLink']))

        # Changing field 'Tweet.tweet_img'
        db.alter_column(u'project_tweet', 'tweet_img_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['project.TweetImg']))

        # Changing field 'Tweet.feed_item'
        db.alter_column(u'project_tweet', 'feed_item_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['project.FeedItem']))
