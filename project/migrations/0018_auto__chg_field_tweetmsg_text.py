...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TweetMsg.text'
        db.alter_column(u'project_tweetmsg', 'text', self.gf('django.db.models.fields.CharField')(max_length=101))

    def backwards(self, orm):

        # Changing field 'TweetMsg.text'
        db.alter_column(u'project_tweetmsg', 'text', self.gf('django.db.models.fields.CharField')(max_length=160))
    ...
    models = {
        ...
        u'project.tweetmsg': {
            ...
            'text': ('django.db.models.fields.CharField', [], {'max_length': '101', 'blank': 'True'})
        },
