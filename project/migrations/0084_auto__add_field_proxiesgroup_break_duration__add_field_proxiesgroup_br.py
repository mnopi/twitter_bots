...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProxiesGroup.break_duration'
        db.add_column(u'project_proxiesgroup', 'break_duration',
                      self.gf('django.db.models.fields.CharField')(default='5-10', max_length=10),
                      keep_default=False)

        # Adding field 'ProxiesGroup.break_interval'
        db.add_column(u'project_proxiesgroup', 'break_interval',
                      self.gf('django.db.models.fields.CharField')(default='24-30', max_length=10),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProxiesGroup.break_duration'
        db.delete_column(u'project_proxiesgroup', 'break_duration')

        # Deleting field 'ProxiesGroup.break_interval'
        db.delete_column(u'project_proxiesgroup', 'break_interval')
    ...
    models = {
        ...
        u'core.twitterbot': {
            ...
            'current_break_date_start': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'current_break_duration': ('django.db.models.fields.PositiveIntegerField', [], {}),
            ...
            'is_being_used': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            ...
            'next_break_date_start': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
        ...
        u'project.extractor': {
            ...
            'date_suspended': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'project.feedsgroup': {
            ...
            'feeds': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'feeds_groups'", 'symmetrical': 'False', 'to': u"orm['project.Feed']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'proxies_groups': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'feeds_groups'", 'symmetrical': 'False', 'to': u"orm['project.ProxiesGroup']"})
        },
        u'project.follower': {
        ...
        u'project.hashtag': {
            ...
            'current_round_oldest_tweet_limit': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'current_round_user_count': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'has_to_wait_timewindow_because_of_not_enough_new_twitterusers': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'lang': ('django.db.models.fields.CharField', [], {'max_length': '2', 'null': 'True', 'blank': 'True'}),
            'last_round_end_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'max_consecutive_pages_retrieved': ('django.db.models.fields.PositiveIntegerField', [], {'default': '10'}),
            'max_id': ('django.db.models.fields.BigIntegerField', [], {'null': 'True', 'blank': 'True'}),
            'next_round_oldest_tweet_limit': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'num_consecutive_pages_without_enough_new_twitterusers': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0', 'null': 'True'}),
        ...
        u'project.pagelink': {
            ...
            'project': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'pagelinks'", 'null': 'True', 'to': u"orm['project.Project']"})
        },
        ...
        u'project.proxiesgroup': {
            ...
            'avatar_required_to_send_tweets': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'bio_required_to_send_tweets': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'break_duration': ('django.db.models.fields.CharField', [], {'default': "'5-10'", 'max_length': '10'}),
            'break_interval': ('django.db.models.fields.CharField', [], {'default': "'24-30'", 'max_length': '10'}),
            ...
            'has_following_activated': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            ...
            'max_num_users_to_follow_at_once': ('django.db.models.fields.CharField', [], {'default': "'1-8'", 'max_length': '10'}),
            ...
            'max_tweets_at_once': ('django.db.models.fields.CharField', [], {'default': "'15-20'", 'max_length': '10'}),
        ...
        u'project.targetuser': {
            ...
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'is_suspended': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'next_cursor': ('django.db.models.fields.BigIntegerField', [], {'default': '0', 'null': 'True', 'blank': 'True'}),
            'num_consecutive_pages_without_enough_new_twitterusers': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0', 'null': 'True'}),
        ...
        u'project.tweet': {
            ...
            'sent_ok': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'db_index': 'True'}),
        ...
        u'project.twitterbotfollowing': {
            'Meta': {'object_name': 'TwitterBotFollowing'},
            'bot': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'tb_followings'", 'to': u"orm['core.TwitterBot']"}),
            'date_followed': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'followed_ok': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'performed_follow': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'twitteruser': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'tb_followings'", 'to': u"orm['project.TwitterUser']"})
        },
