...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Sublink'
        db.create_table(u'project_sublink', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('url', self.gf('django.db.models.fields.URLField')(max_length=200)),
            ('parent_link', self.gf('django.db.models.fields.related.ForeignKey')(related_name='sublinks', to=orm['project.Link'])),
            ('platform', self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True)),
            ('language', self.gf('django.db.models.fields.CharField')(default='en', max_length=2)),
        ))
        db.send_create_signal(u'project', ['Sublink'])

        # Deleting field 'Link.platform'
        db.delete_column(u'project_link', 'platform')

        # Adding field 'ProxiesGroup.is_bot_creation_enabled'
        db.add_column(u'project_proxiesgroup', 'is_bot_creation_enabled',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Sublink'
        db.delete_table(u'project_sublink')

        # Adding field 'Link.platform'
        db.add_column(u'project_link', 'platform',
                      self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'ProxiesGroup.is_bot_creation_enabled'
        db.delete_column(u'project_proxiesgroup', 'is_bot_creation_enabled')
