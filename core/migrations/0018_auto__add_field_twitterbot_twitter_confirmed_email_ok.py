...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TwitterBot.twitter_confirmed_email_ok'
        db.add_column(u'core_twitterbot', 'twitter_confirmed_email_ok',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TwitterBot.twitter_confirmed_email_ok'
        db.delete_column(u'core_twitterbot', 'twitter_confirmed_email_ok')
