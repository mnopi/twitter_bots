...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ProxyUsage.account'
        db.alter_column(u'core_proxyusage', 'account', self.gf('django.db.models.fields.IntegerField')(max_length=1))

    def backwards(self, orm):

        # Changing field 'ProxyUsage.account'
        db.alter_column(u'core_proxyusage', 'account', self.gf('django.db.models.fields.CharField')(max_length=100))
    ...
    models = {
        ...
        u'core.proxyusage': {
            'Meta': {'object_name': 'ProxyUsage'},
            'account': ('django.db.models.fields.IntegerField', [], {'max_length': '1', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
