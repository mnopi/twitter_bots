...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Tweet', fields ['sending']
        db.create_index(u'project_tweet', ['sending'])

        # Adding index on 'Tweet', fields ['date_sent']
        db.create_index(u'project_tweet', ['date_sent'])

        # Adding index on 'Tweet', fields ['sent_ok']
        db.create_index(u'project_tweet', ['sent_ok'])


    def backwards(self, orm):
        # Removing index on 'Tweet', fields ['sent_ok']
        db.delete_index(u'project_tweet', ['sent_ok'])

        # Removing index on 'Tweet', fields ['date_sent']
        db.delete_index(u'project_tweet', ['date_sent'])

        # Removing index on 'Tweet', fields ['sending']
        db.delete_index(u'project_tweet', ['sending'])
